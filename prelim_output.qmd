...
fit <- censReg(fw_total ~ psycap + socopp + phyopp + refmot + autmot, data=df)

kable(coef(summary(fit)), digits = 2, caption = "Tobit model summary")
logLik(fit)

teststat <- -2 * (logLik(fit)-logLik(fit_lm))
